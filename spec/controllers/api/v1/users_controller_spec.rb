...
describe Api::V1::UsersController do
  ...
  describe '#show' do
    before(:each) do
      ...
      # Prevent real HTTP calls to Steam community during tests; return
      # a minimal stubbed steam profile object instead.
      allow(SteamCondenser::Community::SteamId).to receive(:from_steam_id) do |arg|
        OpenStruct.new(base_url: nil, nickname: nil, id: @user.steamid)
      end
    end
