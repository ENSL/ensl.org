...
RSpec.describe Match, type: :model do
  describe 'league recalculation and reset' do
    it 'adds points on league match creation' do
      ...
      described_class.create!(contest: contest, contester1: cont1, contester2: cont2, score1: 5, score2: 3,
    ...
    it 'updates points when league scores are changed' do
      ...
      match = described_class.create!(contest: contest, contester1: cont1, contester2: cont2, score1: 4, score2: 1,
                                      match_time: Time.now.utc)

      cont1.reload
      cont2.reload
      expect([cont1.score, cont2.score]).to contain_exactly(4, 1)

      match.update!(score1: 2, score2: 2)

      cont1.reload
      cont2.reload
      expect([cont1.score, cont2.score]).to contain_exactly(2, 2)
      expect([cont1.draw, cont2.draw]).to contain_exactly(1, 1)
      expect([cont1.win, cont2.loss]).to contain_exactly(0, 0)
    end
    ...
    it 'does not alter points when league contesters are inactive' do
      ...
      described_class.create!(contest: contest, contester1: cont1, contester2: cont2, score1: 3, score2: 1,
                              match_time: Time.now.utc)
      ...
      expect([cont1.score, cont2.score]).to contain_exactly(10, 10)
    end
    ...
    it 'keeps league points non-negative' do
      ...
      described_class.create!(contest: contest, contester1: cont1, contester2: cont2, score1: 0, score2: 0,
                              match_time: Time.now.utc)

      cont1.reload
      cont2.reload
      expect([cont1.score, cont2.score]).to contain_exactly(0, 0)
    end
    ...
    it 'resets league points when match is destroyed' do
      ...
      match = described_class.create!(contest: contest, contester1: cont1, contester2: cont2, score1: 1, score2: 0,
                                      match_time: Time.now.utc)
