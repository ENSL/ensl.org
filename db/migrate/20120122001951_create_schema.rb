class CreateSchema < ActiveRecord::Migration[4.2]
  def up
    ...
    add_index 'articles', %w[created_at status], name: 'index_articles_on_created_at_and_status'
    ...
    add_index 'comments', %w[commentable_type commentable_id],
              name: 'index_comments_on_commentable_type_and_commentable_id'
    add_index 'comments', %w[commentable_type id], name: 'index_comments_on_commentable_type_and_id'
    ...
    add_index 'contests_maps', %w[contest_id map_id], name: 'index_contests_maps_on_contest_id_and_map_id'
    add_index 'contests_maps', %w[map_id contest_id], name: 'index_contests_maps_on_map_id_and_contest_id'
    ...
    add_index 'gatherers', %w[updated_at gather_id], name: 'index_gatherers_on_updated_at_and_gather_id'
    ...
    add_index 'locks', %w[lockable_id lockable_type], name: 'index_locks_on_lockable_id_and_lockable_type'
    ...
    add_index 'matches', %w[score1 score2], name: 'index_matches_on_score1_and_score2'
    ...
    add_index 'messages', %w[recipient_id recipient_type],
              name: 'index_messages_on_recipient_id_and_recipient_type'
    add_index 'messages', %w[sender_id sender_type], name: 'index_messages_on_sender_id_and_sender_type'
    ...
    add_index 'ratings', %w[rateable_id rateable_type], name: 'index_ratings_on_rateable_id_and_rateable_type'
    ...
    add_index 'readings', %w[readable_type readable_id], name: 'index_readings_on_readable_type_and_readable_id'
    add_index 'readings', %w[user_id readable_id readable_type],
    ...
    add_index 'servers', %w[players domain], name: 'index_servers_on_players_and_domain'
    add_index 'servers', ['user_id'], name: 'index_servers_on_user_id'

    create_table 'sessions', force: true do |t|
      t.string   'session_id', null: false
      t.text     'data', limit: 2_147_483_647
      t.datetime 'created_at'
      t.datetime 'updated_at'
    end
    ...
    add_index 'shoutmsgs', %w[shoutable_type shoutable_id],
              name: 'index_shoutmsgs_on_shoutable_type_and_shoutable_id'
    ...
    add_index 'view_counts', %w[viewable_type viewable_id],
              name: 'index_view_counts_on_viewable_type_and_viewable_id'
