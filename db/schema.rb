...
ActiveRecord::Schema[8.1].define(version: 20_260_621_170_000) do
  create_table 'article_versions', id: :integer, charset: 'utf8mb4', collation: 'utf8mb4_unicode_ci',
                                   force: :cascade do |t|
  ...
  create_table 'articles', id: :integer, charset: 'utf8mb4', collation: 'utf8mb4_unicode_ci', force: :cascade do |t|
    ...
    t.index %w[created_at status], name: 'index_articles_on_created_at_and_status'
  ...
  create_table 'comments', id: :integer, charset: 'utf8mb4', collation: 'utf8mb4_unicode_ci', force: :cascade do |t|
    ...
    t.index %w[commentable_type id], name: 'index_comments_on_commentable_type_and_id'
  ...
  create_table 'contests_maps', id: false, charset: 'utf8mb3', collation: 'utf8mb3_general_ci', force: :cascade do |t|
    t.integer 'contest_id'
    t.integer 'map_id'
    t.index %w[contest_id map_id], name: 'index_contests_maps_on_contest_id_and_map_id'
    t.index %w[map_id contest_id], name: 'index_contests_maps_on_map_id_and_contest_id'
  end
  ...
  create_table 'directories', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_general_ci', force: :cascade do |t|
    ...
    t.index %w[st_dev st_ino], name: 'index_directories_on_inode', unique: true
  end
  ...
  create_table 'gatherers', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_swedish_ci', force: :cascade do |t|
    ...
    t.index %w[gather_id pick_order], name: 'index_gatherers_on_gather_id_and_pick_order'
    t.index ['gather_id'], name: 'index_gatherers_on_gather_id'
    t.index %w[updated_at gather_id], name: 'index_gatherers_on_updated_at_and_gather_id'
  ...
  create_table 'locks', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_swedish_ci', force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: nil
    t.index %w[lockable_id lockable_type], name: 'index_locks_on_lockable_id_and_lockable_type'
  end
  ...
  create_table 'match_proposals', id: :integer, charset: 'latin1', collation: 'latin1_swedish_ci',
                                  force: :cascade do |t|
    t.integer 'match_id'
  ...
  create_table 'matches', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_general_ci', force: :cascade do |t|
    ...
    t.index %w[score1 score2], name: 'index_matches_on_score1_and_score2'
  ...
  create_table 'messages', id: :integer, charset: 'utf8mb4', collation: 'utf8mb4_unicode_ci', force: :cascade do |t|
    ...
    t.string 'title'
    t.datetime 'updated_at', precision: nil
    t.index %w[recipient_id recipient_type], name: 'index_messages_on_recipient_id_and_recipient_type'
    t.index %w[sender_id sender_type], name: 'index_messages_on_sender_id_and_sender_type'
  end
  ...
  create_table 'ratings', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_general_ci', force: :cascade do |t|
    ...
    t.index %w[rateable_id rateable_type], name: 'index_ratings_on_rateable_id_and_rateable_type'
  ...
  create_table 'readings', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_general_ci', force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: nil
    t.integer 'user_id'
    t.index %w[readable_type readable_id], name: 'index_readings_on_readable_type_and_readable_id'
    t.index %w[user_id readable_id readable_type],
            name: 'index_readings_on_user_id_and_readable_id_and_readable_type'
  ...
  create_table 'server_versions', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_general_ci',
                                  force: :cascade do |t|
    t.integer 'category_id'
    t.datetime 'created_at', precision: nil
    t.string 'map'
  ...
  create_table 'servers', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_general_ci', force: :cascade do |t|
    ...
    t.index %w[players domain], name: 'index_servers_on_players_and_domain'
    t.index %w[recordable_id recordable_type], name: 'index_servers_on_recordable_id_and_recordable_type'
  ...
  create_table 'shoutmsg_archive', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_general_ci',
                                   force: :cascade do |t|
    t.datetime 'created_at', precision: nil
    ...
    t.datetime 'updated_at', precision: nil
    t.integer 'user_id'
    t.index %w[shoutable_type shoutable_id], name: 'index_shoutmsgs_on_shoutable_type_and_shoutable_id'
  ...
  create_table 'user_versions', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_general_ci',
                                force: :cascade do |t|
    t.string 'lastip'
    t.string 'steamid'
    t.datetime 'updated_at', precision: nil
  ...
  create_table 'view_counts', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_general_ci', force: :cascade do |t|
    ...
    t.index %w[viewable_type viewable_id], name: 'index_view_counts_on_viewable_type_and_viewable_id'
  end
