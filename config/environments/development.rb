...
Rails.application.configure do
  ...
  # Allow Web Console from Docker/internal networks.
  # Override with WEB_CONSOLE_ALLOWED_IPS (comma-separated CIDRs) if needed.
  config.web_console.permissions = ENV.fetch(
    'WEB_CONSOLE_ALLOWED_IPS',
    '127.0.0.0/8,::1,10.0.0.0/8,172.0.0.0/8,192.168.0.0/16'
  ).split(',').map(&:strip)
end
